...
console.dir(gmarkers);
    ...
    <a href="#contact" id="schedBtn" class="isOnTop"><span>Schedule a consultation</span></a>
     ...
     <div id="globalMessage" title="Permanently closed" style="display:none;">
        <img alt="Minimally Invasive Brain and Spine Logo" src="/wp-content/themes/mibs/img/mibs-logo.png">
        <br /><br /><br /><p>Minimally Invasive Brain and Spine is permanently closed. If you need to obtain copies of medical records, please note our office can only provide office notes for  patients seen in our clinic. If you were only seen in a hospital setting or had a procedure by Dr. Maioriello, Charise Sullivan or Stephen Miller, you will need to contact the facility where the procedure was performed to obtain records directly from that facility. </p>

        <p>If you have a balance on your account with Minimally Invasive Brain and Spine, payment is expected in order to avoid collections or any credit reporting. </p>

        <p>To make your request for medical records, please send a written request with your name, date of birth and a $25.00 money order or cashiers check only.  We will not accept any requests that are received without payment and this will ultimately delay any processing of you request.  Please allow 60 days for processing if all requirements have been received. Please send your request to: </p>

        <p align="center"><strong>Minimally Invasive Brain and Spine<br />
        P. O Box 195788<br />
        Dallas, TX 75219-5788</strong></p>
    </div>
<?php wp_footer(); ?>
</body>
</html>
